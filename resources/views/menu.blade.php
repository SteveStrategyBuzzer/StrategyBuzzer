...
<div class="sb-layout">
    ...
    <aside class="sb-sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ R::has('duo.rankings') ? route('duo.rankings') : url('/duo/rankings') }}" class="sb-nav-item">
                <div class="sb-nav-icon">
    ...
    <div class="sb-main">
        ...
        <footer class="sb-bottombar">
            ...
            {{-- Réseaux sociaux masqués temporairement (URLs réelles indisponibles ; à réactiver plus tard)
