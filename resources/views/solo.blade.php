...
@media (max-width: 640px) {
  ...
  /* Sur mobile : nom avatar seul sur la 1ère ligne, icônes centrées sur la 2e */
  .sl-strat-bottom { flex-wrap: wrap; gap: 8px 6px; justify-content: center; }
  .sl-strat-name { flex: 0 0 100%; white-space: normal; font-size: 0.82rem; text-align: center; }
  .sl-skill-cards { flex-wrap: wrap; gap: 6px; justify-content: center; width: 100%; }
