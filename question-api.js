...
// single unanchored call, violating the master-first coherence contract and
// producing broken TF-variant polarity (isTF bug: startsWith('true_false')
// instead of startsWith('tf_')).
//
// Use the two-step pipeline instead:
//   1. POST /generate-kernel-master        — generates qcm_recognition anchor
//   2. POST /generate-kernel-derived-variants — generates 6 derived variants
//      (qcm_reasoning, qcm_deceptive_trap, tf_recognition_true/false,
//       tf_reasoning_true/false) with POLARITY_LOCK enforced.
// =============================================================================
app.post('/generate-kernel-variants', (req, res) => {
  return res.status(410).json({
    ok: false,
    error: 'deprecated_endpoint',
    detail: 'POST /generate-kernel-variants is permanently disabled. Use POST /generate-kernel-master followed by POST /generate-kernel-derived-variants.',
    replacement: [
