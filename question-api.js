...
// Catalogue ÉTENDU de sous-thèmes pour garantir la diversité des questions
// Chaque thème a 25-30 sous-thèmes pour couvrir tous les aspects
const SUBTHEME_CATALOG = {
  // ============ GÉOGRAPHIE (30 sous-thèmes) ============
  'géographie': [
    'les capitales européennes',
    'les capitales africaines',
    'les capitales asiatiques',
    'les capitales américaines',
    'les fleuves les plus longs du monde',
    'les rivières d\'Europe',
    'les chaînes de montagnes célèbres',
    'les sommets les plus hauts par continent',
    'les océans et leurs caractéristiques',
    'les mers intérieures et fermées',
    'les pays les plus grands en superficie',
    'les pays les plus peuplés',
    'les drapeaux avec des étoiles',
    'les drapeaux avec des couleurs panafricaines ou panarabes',
    'les monuments classés UNESCO',
    'les merveilles du monde moderne',
    'les déserts du monde (autre que le Sahara)',
    'les forêts tropicales',
    'les îles les plus grandes',
    'les archipels célèbres',
    'les lacs d\'eau douce les plus grands',
    'les volcans actifs d\'Asie et Amérique',
    'les fuseaux horaires',
    'les pays enclavés (sans accès à la mer)',
    'les détroits et canaux célèbres',
    'les capitales qui ont changé de nom',
    'les frontières les plus longues',
    'les pays avec plusieurs capitales',
    'les territoires d\'outre-mer',
    'les villes les plus hautes en altitude'
  ],
  'geography': [
    'European capitals',
    'African capitals',
    ...
    'inland and enclosed seas',
    'largest countries by area',
    'most populous countries',
    'flags with stars',
    'flags with Pan-African or Pan-Arab colors',
    'UNESCO World Heritage sites',
    'modern wonders of the world',
    'deserts of the world (other than Sahara)',
    'tropical rainforests',
    'largest islands',
    'famous archipelagos',
    'largest freshwater lakes',
    'active volcanoes in Asia and America',
    'time zones',
    'landlocked countries',
    'famous straits and canals',
    'capitals that changed names',
    'longest borders',
    'countries with multiple capitals',
    'overseas territories',
    'highest altitude cities'
  ],
  
  // ============ HISTOIRE (30 sous-thèmes) ============
  'histoire': [
    'la Première Guerre mondiale (batailles, dates)',
    'la Seconde Guerre mondiale (événements clés)',
    'l\'Égypte ancienne (pharaons, pyramides)',
    'la Rome antique (empereurs, conquêtes)',
    'la Grèce antique (philosophes, cités)',
    'la civilisation maya et aztèque',
    'la Révolution française (personnages, dates)',
    'la Révolution industrielle',
    'les grandes découvertes maritimes',
    'les explorateurs du 15e-16e siècle',
    'les inventions du 19e siècle',
    'les inventions du 20e siècle',
    'les rois de France',
    'les reines d\'Angleterre',
    'l\'Empire romain (expansion, chute)',
    'l\'Empire ottoman',
    'l\'Empire mongol',
    'les croisades',
    ...
    'les traités de paix célèbres',
    'les présidents américains',
    'les dirigeants de la Chine ancienne',
    'les samouraïs et le Japon féodal',
    'les Vikings et leurs conquêtes',
    'la Révolution russe',
    'les années 1960 (mouvements sociaux)'
  ],
  'history': [
    'World War I (battles, dates)',
    'World War II (key events)',
    'Ancient Egypt (pharaohs, pyramids)',
    'Ancient Rome (emperors, conquests)',
    'Ancient Greece (philosophers, city-states)',
    'Mayan and Aztec civilization',
    'French Revolution (figures, dates)',
    'Industrial Revolution',
    'Age of Discovery',
    'explorers of the 15th-16th century',
    'inventions of the 19th century',
    'inventions of the 20th century',
    'kings of France',
    'queens of England',
    'Roman Empire (expansion, fall)',
    'Ottoman Empire',
    'Mongol Empire',
    'the Crusades',
    'Italian Renaissance',
    ...
    'Vikings and their conquests',
    'Russian Revolution',
    'the 1960s (social movements)'
  ],
  
  // ============ SPORT (30 sous-thèmes) ============
  'sport': [
    'la Coupe du monde de football (vainqueurs)',
    'la Ligue des Champions (clubs, records)',
    'les légendes du football (Pelé, Maradona, etc.)',
    'les Jeux Olympiques d\'été (records)',
    'les Jeux Olympiques d\'hiver',
    'les champions de tennis (Grand Chelem)',
    'Wimbledon (histoire, champions)',
    'la NBA (équipes légendaires)',
    'les joueurs de basketball (Jordan, LeBron)',
    'la Formule 1 (champions, circuits)',
    'le rallye (Dakar, WRC)',
    'le Tour de France (maillots, étapes)',
    'les cyclistes légendaires',
    'la natation olympique',
    'les records du monde en athlétisme',
    'les arts martiaux (judo, karaté, taekwondo)',
    'la boxe (champions poids lourds)',
    'le rugby (Coupe du monde, équipes)',
    'le hockey sur glace (NHL)',
    'le baseball (MLB, records)',
    'le golf (majeurs, légendes)',
    'le ski alpin (champions)',
    'le patinage artistique',
    'les sports extrêmes',
    'le volleyball et beach-volley',
    'le handball (championnats)',
    'l\'escrime olympique',
    'le tennis de table',
    'les Jeux Paralympiques',
    'les stades mythiques du monde'
  ],
  'sports': [
    'FIFA World Cup (winners)',
    'Champions League (clubs, records)',
    'football legends (Pelé, Maradona, etc.)',
    'Summer Olympics (records)',
    'Winter Olympics',
    'tennis champions (Grand Slam)',
    'Wimbledon (history, champions)',
    'NBA (legendary teams)',
    'basketball players (Jordan, LeBron)',
    'Formula 1 (champions, circuits)',
    'rally (Dakar, WRC)',
    'Tour de France (jerseys, stages)',
    'legendary cyclists',
    'Olympic swimming',
    ...
    'table tennis',
    'Paralympic Games',
    'mythical stadiums of the world'
  ],
  
  // ============ SCIENCES (30 sous-thèmes) ============
  'sciences': [
    'les planètes du système solaire',
    'les lunes et satellites naturels',
    'les étoiles et constellations',
    'les trous noirs et galaxies',
    'le corps humain (les os)',
    'le corps humain (les organes vitaux)',
    'le système nerveux',
    'le système digestif',
    'les éléments chimiques (tableau périodique)',
    'les réactions chimiques courantes',
    'les physiciens célèbres (Einstein, Newton)',
    'les lois de la physique',
    'l\'électricité et le magnétisme',
    'la biologie cellulaire',
    'l\'ADN et la génétique',
    'l\'évolution des espèces',
    'les dinosaures (espèces, extinction)',
    ...
    'les missions spatiales (Apollo, Mars)',
    'les prix Nobel de sciences'
  ],
  'science': [
    ...
    'human body (bones)',
    'human body (vital organs)',
    'nervous system',
    'digestive system',
    'chemical elements (periodic table)',
    'common chemical reactions',
    'famous physicists (Einstein, Newton)',
    'laws of physics',
    'electricity and magnetism',
    'cell biology',
    'DNA and genetics',
    'evolution of species',
    'dinosaurs (species, extinction)',
    'human prehistory',
    ...
    'space missions (Apollo, Mars)',
    'Nobel Prizes in science'
  ],
  
  // ============ CINÉMA (30 sous-thèmes) ============
  'cinéma': [
    'les films oscarisés du meilleur film',
    'les Oscars du meilleur acteur/actrice',
    'les réalisateurs américains légendaires',
    'les réalisateurs européens',
    'les acteurs hollywoodiens classiques',
    'les actrices hollywoodiennes classiques',
    'les films Disney classiques',
    'les films Pixar',
    'les films d\'animation japonaise (Ghibli)',
    'la saga Star Wars',
    'l\'univers Marvel (MCU)',
    'l\'univers DC Comics',
    'les films James Bond',
    'les films cultes des années 80',
    'les films cultes des années 90',
    'les comédies musicales classiques',
    'les films de science-fiction classiques',
    'les films d\'horreur iconiques',
    'les thrillers célèbres',
    'les westerns légendaires',
    'les répliques cultes de films',
    'les bandes originales oscarisées',
    'les compositeurs de musiques de films',
    'le cinéma français (Nouvelle Vague)',
    'les films de Quentin Tarantino',
    'les films de Steven Spielberg',
    'les films de Christopher Nolan',
    'les films basés sur des livres',
    'les sagas Harry Potter et Le Seigneur des Anneaux',
    'les festivals de cinéma (Cannes, Venise)'
  ],
  'cinema': [
    'Best Picture Oscar winners',
    'Best Actor/Actress Oscars',
    'legendary American directors',
    'European directors',
    'classic Hollywood actors',
    'classic Hollywood actresses',
    'classic Disney films',
    'Pixar films',
    'Japanese animation films (Ghibli)',
    'Star Wars saga',
    ...
    'Harry Potter and Lord of the Rings sagas',
    'film festivals (Cannes, Venice)'
  ],
  
  // ============ ART ET CULTURE (30 sous-thèmes) ============
  'art': [
    ...
    'les musées d\'art du monde',
    'le Louvre et ses œuvres',
    'les sculpteurs célèbres',
    'l\'architecture gothique',
    'l\'architecture moderne',
    'les gratte-ciels célèbres',
    'les compositeurs classiques (Mozart, Beethoven)',
    'les opéras célèbres',
    'les symphonies classiques',
    'les écrivains français classiques',
    'les écrivains américains',
    'les prix Nobel de littérature',
    'Shakespeare et son œuvre',
    'les pièces de théâtre classiques',
    'la photographie artistique',
    'les photographes célèbres',
    'l\'art contemporain',
    'le street art et Banksy',
    'les ballets classiques',
    'les instruments à cordes',
    'les instruments à vent',
    'la mode et les grands couturiers',
    'le design et le Bauhaus',
    'les bandes dessinées et comics'
  ],
  'art et culture': [
    'les peintres de la Renaissance',
    'les peintres impressionnistes',
  ...
  // ============ ANIMAUX ET NATURE (30 sous-thèmes) ============
  'animaux': [
    'les félins (lions, tigres, léopards)',
    'les primates (singes, gorilles)',
    'les ours et pandas',
    'les éléphants et rhinocéros',
    'les canidés (loups, renards)',
    'les oiseaux de proie (aigles, faucons)',
    'les oiseaux tropicaux (perroquets, toucans)',
    'les oiseaux migrateurs',
    'les requins et raies',
    'les baleines et dauphins',
    'les poissons tropicaux',
    'les méduses et pieuvres',
    'les serpents venimeux',
    'les crocodiles et alligators',
    'les tortues marines et terrestres',
    'les grenouilles et salamandres',
    'les insectes pollinisateurs (abeilles)',
    'les papillons',
    ...
    'les animaux domestiques (chats)',
    'les records du règne animal',
    'les arbres remarquables',
    'les fleurs et plantes médicinales',
    'les champignons',
    'les écosystèmes marins (récifs coralliens)'
  ],
  'faune': [
    'les félins (lions, tigres, léopards)',
    'les primates (singes, gorilles)',
  ...
  // ============ CUISINE (30 sous-thèmes) ============
  'cuisine': [
    'les plats français traditionnels',
    'les plats italiens',
    'les plats asiatiques (Chine, Japon)',
    'les plats mexicains et tex-mex',
    'les plats indiens',
    'les épices et leurs origines',
    'les herbes aromatiques',
    'les desserts français',
    'les pâtisseries du monde',
    'les chocolats et confiseries',
    'les vins français (régions)',
    'les vins du monde',
    'les spiritueux (whisky, rhum, vodka)',
    'les fromages français',
    'les fromages européens',
    'les techniques de cuisson',
    'les termes culinaires français',
    'les chefs étoilés Michelin',
    'les chefs télévisés célèbres',
    'les fruits exotiques',
    'les légumes oubliés',
    'les céréales et graines',
    'le café et ses variétés',
    'le thé et ses traditions',
    'les cocktails classiques',
    'les traditions culinaires de Noël',
    'les traditions culinaires asiatiques',
    'les régimes alimentaires (végan, sans gluten)',
    'les ustensiles de cuisine spéciaux',
    'les restaurants les plus étoilés au monde'
  ],
  ...
  // ============ CULTURE GÉNÉRALE (30 sous-thèmes) ============
  'culture générale': [
    'les capitales des pays européens',
    'les capitales des pays d\'Afrique',
    'les personnages historiques français',
    'les personnages historiques américains',
    'les inventions du quotidien',
    'les inventions qui ont changé le monde',
    'les expressions françaises et leur origine',
    'les proverbes du monde',
    'les drapeaux et leurs symboles',
    'les hymnes nationaux',
    'les records Guinness insolites',
    'les records de vitesse et distance',
    'les fêtes nationales',
    'les traditions de mariage dans le monde',
    'les personnalités politiques actuelles',
    'les entrepreneurs et milliardaires',
    'les marques de luxe',
    'les marques technologiques',
    'les événements de 2020-2024',
    'les catastrophes naturelles célèbres',
    'les mythes grecs',
    ...
    'les superstitions dans le monde',
  ...
  'general knowledge': [
    ...
    'French expressions and their origins',
    ...
    'current political personalities',
  ...
  // ============ MUSIQUE (NOUVEAU - 30 sous-thèmes) ============
  'musique': [
    'les chanteurs pop internationaux',
    'les chanteuses pop internationales',
    'les groupes de rock légendaires',
    'le rock des années 70-80',
    'les rappeurs américains',
    'le rap français',
    'les artistes R&B',
    'la musique électronique et DJs',
    'les chanteurs français classiques',
    'les chanteuses françaises',
    'les Beatles et leur histoire',
    'Michael Jackson',
    'les albums les plus vendus',
    'les chansons numéro 1',
    'les festivals de musique',
    'les Grammy Awards',
    'les instruments de musique',
    'les compositeurs de musique classique',
    'les opéras célèbres',
    'le jazz et ses légendes',
    'le blues et ses origines',
    'la musique latino',
    'la K-pop',
    'les tubes des années 80',
    'les tubes des années 90',
    'les tubes des années 2000',
    'les groupes de metal',
    'les auteurs-compositeurs',
    'les collaborations musicales célèbres',
    'les reprises et covers célèbres'
  ],
  'music': [
    'international pop male artists',
    'international pop female artists',
    ...
    'classic French male singers',
    'French female singers',
    'The Beatles and their history',
    'Michael Jackson',
    'best-selling albums',
    'number one songs',
    'music festivals',
    ...
    'metal bands',
    'singer-songwriters',
    'famous musical collaborations',
    'famous covers and remakes'
  ],

  // ============ TECHNOLOGIE (NOUVEAU - 25 sous-thèmes) ============
  'technologie': [
    'les fondateurs de grandes entreprises tech',
    'l\'histoire d\'Apple',
    'l\'histoire de Google',
    'l\'histoire de Microsoft',
    'les réseaux sociaux et leurs créateurs',
    'les smartphones et leur évolution',
    'les jeux vidéo classiques',
    'les consoles de jeux vidéo',
    'l\'intelligence artificielle',
    'les robots et la robotique',
    'internet et son histoire',
    'les sites web les plus visités',
    'les applications mobiles populaires',
    'les hackers célèbres',
    'la cybersécurité',
    'les cryptomonnaies',
    'les voitures électriques',
    'les inventions technologiques récentes',
    'l\'exploration spatiale privée (SpaceX)',
    'les ordinateurs et leur histoire',
    'les langages de programmation',
    'les jeux vidéo les plus vendus',
    'les streamers et YouTubers gaming',
    'la réalité virtuelle et augmentée',
    'les gadgets technologiques'
  ],
  'technology': [
    'founders of big tech companies',
    'history of Apple',
    'history of Google',
    'history of Microsoft',
    'social networks and their creators',
  ...
  // ============ LITTÉRATURE (NOUVEAU - 25 sous-thèmes) ============
  'littérature': [
    'les écrivains français du 19e siècle',
    'les écrivains français du 20e siècle',
    'les écrivains américains',
    'les écrivains britanniques',
    'les prix Nobel de littérature',
    'les romans classiques français',
    ...
    'les best-sellers mondiaux',
    'les sagas littéraires (Harry Potter, etc.)',
    'les bandes dessinées franco-belges',
    'les mangas célèbres',
    'les adaptations de livres au cinéma',
    'les personnages littéraires célèbres',
    'les premières phrases célèbres de romans',
    'les éditeurs et maisons d\'édition',
    'les prix littéraires français (Goncourt, etc.)',
    'la mythologie dans la littérature'
  ],
  'literature': [
    ...
    'romantic poets',
    'world bestsellers',
    'literary sagas (Harry Potter, etc.)',
    'Franco-Belgian comics',
    'famous manga',
    'book-to-film adaptations',
    'famous literary characters',
    'famous opening lines of novels',
    'publishers and publishing houses',
    'French literary prizes (Goncourt, etc.)',
    'mythology in literature'
  ],

  // ============ MYTHOLOGIE (NOUVEAU - 20 sous-thèmes) ============
  'mythologie': [
    'les dieux grecs de l\'Olympe',
    'les héros grecs (Hercule, Achille)',
    'les créatures mythologiques grecques',
    'les dieux romains',
    'les dieux égyptiens',
    'les dieux nordiques (Odin, Thor)',
    'les créatures de la mythologie nordique',
    'les légendes arthuriennes',
    'les dieux hindous',
    'les créatures mythiques asiatiques (dragons)',
    'les légendes celtiques',
    'les mythes de création du monde',
    'les enfers et paradis dans les mythes',
    'les monstres légendaires (Minotaure, etc.)',
    'les nymphes et divinités mineures',
    'les voyages mythiques (Ulysse, etc.)',
    'les objets magiques dans les mythes',
    'les prophéties et oracles',
    'les métamorphoses dans les mythes',
    'les symboles mythologiques'
  ],
  'mythology': [
    ...
    'Arthurian legends',
    'Hindu gods',
    'Asian mythical creatures (dragons)',
    'Celtic legends',
    'creation myths of the world',
    'underworlds and paradises in myths',
    'legendary monsters (Minotaur, etc.)',
    'nymphs and minor deities',
    'mythical journeys (Odysseus, etc.)',
    'magical objects in myths',
    'prophecies and oracles',
    'metamorphoses in myths',
    'mythological symbols'
  ],

  // ============ JEUX VIDÉO (NOUVEAU - 25 sous-thèmes) ============
  'jeux vidéo': [
    'les jeux Nintendo classiques (Mario, Zelda)',
    'les jeux PlayStation exclusifs',
    'les jeux Xbox exclusifs',
    'les jeux PC légendaires',
    'les jeux de combat (Street Fighter, Tekken)',
    'les jeux de sport (FIFA, NBA 2K)',
    'les jeux de course (Mario Kart, Gran Turismo)',
    'les jeux de rôle (Final Fantasy, etc.)',
    'les jeux d\'aventure',
    'les jeux de tir (Call of Duty, etc.)',
    'les jeux indépendants célèbres',
    'Minecraft et son univers',
    'Fortnite et les Battle Royale',
    'les jeux mobiles populaires',
    'les personnages de jeux vidéo iconiques',
    'les musiques de jeux vidéo',
    'les studios de développement',
    'les consoles de jeux et leur histoire',
    'les jeux rétro des années 80-90',
    'les records et speedruns',
    'l\'esport et les compétitions',
    'les jeux en ligne massivement multijoueurs',
    'les jeux de stratégie',
    'les jeux de simulation',
    'les adaptations de jeux au cinéma'
  ],
  'video games': [
    'classic Nintendo games (Mario, Zelda)',
    'PlayStation exclusives',
    'Xbox exclusives',
    'legendary PC games',
    'fighting games (Street Fighter, Tekken)',
    'sports games (FIFA, NBA 2K)',
    'racing games (Mario Kart, Gran Turismo)',
    'role-playing games (Final Fantasy, etc.)',
    'adventure games',
    'shooter games (Call of Duty, etc.)',
    'famous indie games',
    'Minecraft and its universe',
    'Fortnite and Battle Royale games',
    'popular mobile games',
    'iconic video game characters',
    'video game music',
    'game development studios',
    'gaming consoles and their history',
    'retro games of the 80s-90s',
    'records and speedruns',
  ...
  'français': [
    ...
    'les auteurs du programme scolaire',
    'les fables et contes',
  ...
  'anglais': [
    ...
    'la grammaire anglaise (be, have, do)',
