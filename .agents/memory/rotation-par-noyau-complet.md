...
- **taxonomy.json sous-dimensionné + EAGER** : aujourd'hui 8 domaines × 4 sous-domaines × 4 sujets × 5 idées, TOUTES pré-remplies. Cible (VERROUILLÉ 2026-06-19) : 1 sous-domaine ACTIF × ≤50 sujets (coquilles) × 5 idées générées **LAZY** pour le SUJET ACTIF seulement (autres sujets `dominant_ideas`=EMPTY jusqu'à activation par Rotation/KLD).
