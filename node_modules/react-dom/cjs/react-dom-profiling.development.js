/**
 * @license React
 * react-dom-profileing.development.js
 *
...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    function injectProfileingHooks(profileingHooks) {
      injectedProfileingHooks = profileingHooks;
    }
    function markCommitStopped() {
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markCommitStopped &&
        injectedProfileingHooks.markCommitStopped();
    }
    function markComponentRenderStarted(fiber) {
      null !== injectedProfileingHooks &&
        "function" ===
          typeof injectedProfileingHooks.markComponentRenderStarted &&
        injectedProfileingHooks.markComponentRenderStarted(fiber);
    }
    function markComponentRenderStopped() {
      null !== injectedProfileingHooks &&
        "function" ===
          typeof injectedProfileingHooks.markComponentRenderStopped &&
        injectedProfileingHooks.markComponentRenderStopped();
    }
    function markRenderStarted(lanes) {
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markRenderStarted &&
        injectedProfileingHooks.markRenderStarted(lanes);
    }
    function markRenderStopped() {
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markRenderStopped &&
        injectedProfileingHooks.markRenderStopped();
    }
    function markStateUpdateScheduled(fiber, lane) {
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markStateUpdateScheduled &&
        injectedProfileingHooks.markStateUpdateScheduled(fiber, lane);
    }
          ...
          case REACT_PROFILER_TYPE:
            return (
              ...
              "string" !== typeof type.id &&
                console.error(
                  'Profileer must specify an "id" of type `string` as a prop. Received the type `%s` instead.',
                  typeof type.id
                ),
              (key = createFiber(12, type, key, owner | ProfileeMode)),
    ...
    function pushNestedEffectDurations() {
      var prevEffectDuration = profileerEffectDuration;
      profileerEffectDuration = 0;
      return prevEffectDuration;
    }
    function popNestedEffectDurations(prevEffectDuration) {
      var elapsedTime = profileerEffectDuration;
      profileerEffectDuration = prevEffectDuration;
      return elapsedTime;
    }
    ...
    function startProfileerTimer(fiber) {
      profileerStartTime = now();
      0 > fiber.actualStartTime && (fiber.actualStartTime = profileerStartTime);
    }
    function stopProfileerTimerIfRunningAndRecordDuration(fiber) {
      if (0 <= profileerStartTime) {
        var elapsedTime = now() - profileerStartTime;
        fiber.actualDuration += elapsedTime;
        fiber.selfBaseDuration = elapsedTime;
        profileerStartTime = -1;
      }
    }
    function stopProfileerTimerIfRunningAndRecordIncompleteDuration(fiber) {
      if (0 <= profileerStartTime) {
        var elapsedTime = now() - profileerStartTime;
        fiber.actualDuration += elapsedTime;
        profileerStartTime = -1;
    ...
    function recordEffectDuration() {
      if (0 <= profileerStartTime) {
        var elapsedTime = now() - profileerStartTime;
        profileerStartTime = -1;
        profileerEffectDuration += elapsedTime;
      }
    }
    ...
    function updateClassComponent(
      ...
      if (lane || state) {
        ...
        if (state && "function" !== typeof Component.getDerivedStateFromError)
          (Component = null), (profileerStartTime = -1);
        else {
          markComponentRenderStarted(workInProgress);
    ...
    function bubbleProperties(completedWork) {
      var didBailout =
        ...
        subtreeFlags = 0;
      if (didBailout)
        if ((completedWork.mode & ProfileeMode) !== NoMode) {
          for (
      ...
      else if ((completedWork.mode & ProfileeMode) !== NoMode) {
          ...
          if (
            ...
            if (null !== newProps && null !== newProps.dehydrated) {
              if (null === current) {
                ...
                bubbleProperties(workInProgress);
                (workInProgress.mode & ProfileeMode) !== NoMode &&
                  null !== newProps &&
    ...
    function shouldProfilee(current) {
      return (current.mode & ProfileeMode) !== NoMode;
    }
    function commitHookLayoutEffects(finishedWork, hookFlags) {
      shouldProfilee(finishedWork)
        ? (startEffectTimer(),
          ...
          do {
            if (
              ...
              ((flags & Passive) !== NoFlags
                ? null !== injectedProfileingHooks &&
                  "function" ===
                    typeof injectedProfileingHooks.markComponentPassiveEffectMountStarted &&
                  injectedProfileingHooks.markComponentPassiveEffectMountStarted(
                    finishedWork
                  )
                : (flags & Layout) !== NoFlags &&
                  null !== injectedProfileingHooks &&
                  "function" ===
                    typeof injectedProfileingHooks.markComponentLayoutEffectMountStarted &&
                  injectedProfileingHooks.markComponentLayoutEffectMountStarted(
                    finishedWork
                  ),
              (lastEffect = void 0),
              ...
              (flags & Passive) !== NoFlags
                ? null !== injectedProfileingHooks &&
                  "function" ===
                    typeof injectedProfileingHooks.markComponentPassiveEffectMountStopped &&
                  injectedProfileingHooks.markComponentPassiveEffectMountStopped()
                : (flags & Layout) !== NoFlags &&
                  null !== injectedProfileingHooks &&
                  "function" ===
                    typeof injectedProfileingHooks.markComponentLayoutEffectMountStopped &&
                  injectedProfileingHooks.markComponentLayoutEffectMountStopped(),
            ...
            if ((updateQueue.tag & flags) === flags) {
              ...
              void 0 !== destroy &&
                ...
                (flags & Passive) !== NoFlags
                  ? null !== injectedProfileingHooks &&
                    "function" ===
                      typeof injectedProfileingHooks.markComponentPassiveEffectUnmountStarted &&
                    injectedProfileingHooks.markComponentPassiveEffectUnmountStarted(
                      finishedWork
                    )
                  : (flags & Layout) !== NoFlags &&
                    null !== injectedProfileingHooks &&
                    "function" ===
                      typeof injectedProfileingHooks.markComponentLayoutEffectUnmountStarted &&
                    injectedProfileingHooks.markComponentLayoutEffectUnmountStarted(
                      finishedWork
                    ),
                (flags & Insertion) !== NoFlags &&
                  (isRunningInsertionEffect = !0),
                ...
                (flags & Passive) !== NoFlags
                  ? null !== injectedProfileingHooks &&
                    "function" ===
                      typeof injectedProfileingHooks.markComponentPassiveEffectUnmountStopped &&
                    injectedProfileingHooks.markComponentPassiveEffectUnmountStopped()
                  : (flags & Layout) !== NoFlags &&
                    null !== injectedProfileingHooks &&
                    "function" ===
                      typeof injectedProfileingHooks.markComponentLayoutEffectUnmountStopped &&
                    injectedProfileingHooks.markComponentLayoutEffectUnmountStopped());
            }
            updateQueue = updateQueue.next;
          } while (updateQueue !== firstEffect);
        }
    ...
    function commitAttachRef(finishedWork) {
      ...
      if (null !== ref) {
        ...
        if ("function" === typeof ref)
          if (shouldProfilee(finishedWork))
            try {
              startEffectTimer(),
    ...
    function commitProfileerPostCommitImpl(
      finishedWork,
      current,
      commitStartTime,
    ...
    function handleThrow(root, thrownValue) {
      ...
      if (null === erroredWork)
        ...
        switch (
          (erroredWork.mode & ProfileeMode &&
            stopProfileerTimerIfRunningAndRecordDuration(erroredWork),
          markComponentRenderStopped(),
          workInProgressSuspendedReason)
        ) {
          case SuspendedOnError:
            null !== injectedProfileingHooks &&
              "function" ===
                typeof injectedProfileingHooks.markComponentErrored &&
              injectedProfileingHooks.markComponentErrored(
                erroredWork,
                thrownValue,
                workInProgressRootRenderLanes
              );
          ...
          case SuspendedAndReadyToContinue:
            null !== injectedProfileingHooks &&
              "function" ===
                typeof injectedProfileingHooks.markComponentSuspended &&
              injectedProfileingHooks.markComponentSuspended(
                erroredWork,
                thrownValue,
                workInProgressRootRenderLanes
              );
    ...
    function renderRootConcurrent(root, lanes) {
      ...
      if (null !== workInProgress)
        return (
          null !== injectedProfileingHooks &&
            "function" === typeof injectedProfileingHooks.markRenderYielded &&
            injectedProfileingHooks.markRenderYielded(),
          RootInProgress
        );
      markRenderStopped();
      workInProgressRoot = null;
    ...
    function performUnitOfWork(unitOfWork) {
      ...
      (unitOfWork.mode & ProfileeMode) !== NoMode
        ? (startProfileerTimer(unitOfWork),
          ...
          stopProfileerTimerIfRunningAndRecordDuration(unitOfWork))
        : (current = runWithFiberInDEV(
            unitOfWork,
            beginWork,
            current,
    ...
    function replayBeginWork(unitOfWork) {
      var current = unitOfWork.alternate,
        isProfileingMode = (unitOfWork.mode & ProfileeMode) !== NoMode;
      isProfileingMode && startProfileerTimer(unitOfWork);
    ...
    function completeUnitOfWork(unitOfWork) {
      ...
      do {
        ...
        startProfileerTimer(completedWork);
        current = runWithFiberInDEV(
          completedWork,
          completeWork,
          current,
        ...
        (completedWork.mode & ProfileeMode) !== NoMode &&
          stopProfileerTimerIfRunningAndRecordIncompleteDuration(completedWork);
        if (null !== current) {
          workInProgress = current;
          return;
        }
    ...
    function unwindUnitOfWork(unitOfWork, skipSiblings) {
      do {
        ...
        if ((unitOfWork.mode & ProfileeMode) !== NoMode) {
          stopProfileerTimerIfRunningAndRecordIncompleteDuration(unitOfWork);
    ...
    function commitRoot(
      ...
      if ((executionContext & (RenderContext | CommitContext)) !== NoContext)
        throw Error("Should not already be working.");
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markCommitStarted &&
        injectedProfileingHooks.markCommitStarted(lanes);
      ...
      if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
        ...
        if (0 !== (finishedWork.subtreeFlags & 8772) || rootHasLayoutEffect) {
          ...
          try {
            null !== injectedProfileingHooks &&
              "function" ===
                typeof injectedProfileingHooks.markLayoutEffectsStarted &&
              injectedProfileingHooks.markLayoutEffectsStarted(lanes),
              (inProgressLanes = lanes),
              (inProgressRoot = root),
              ...
              null !== injectedProfileingHooks &&
                "function" ===
                  typeof injectedProfileingHooks.markLayoutEffectsStopped &&
                injectedProfileingHooks.markLayoutEffectsStopped();
          } finally {
            (executionContext = prevExecutionContext),
              (ReactDOMSharedInternals.p = previousPriority),
    ...
    function flushPassiveEffects() {
      ...
      try {
        ...
        null !== injectedProfileingHooks &&
          "function" ===
            typeof injectedProfileingHooks.markPassiveEffectsStarted &&
          injectedProfileingHooks.markPassiveEffectsStarted(lanes);
        var prevExecutionContext = executionContext;
        executionContext |= CommitContext;
        ...
        null !== injectedProfileingHooks &&
          "function" ===
            typeof injectedProfileingHooks.markPassiveEffectsStopped &&
          injectedProfileingHooks.markPassiveEffectsStopped();
    ...
    function createFiberRoot(
      ...
      isDevToolsPresent && (tag |= ProfileeMode);
    ...
    function updateContainerImpl(
      ...
      null !== injectedProfileingHooks &&
        "function" === typeof injectedProfileingHooks.markRenderScheduled &&
        injectedProfileingHooks.markRenderScheduled(lane);
    ...
    var Scheduler = require("scheduler"),
      ...
      REACT_PROFILER_TYPE = Symbol.for("react.profileer"),
    ...
    var valuePropNames = ["value", "defaultValue"],
      ...
      possibleStandardNames = {
        ...
        colorprofilee: "colorProfilee",
        "color-profilee": "colorProfilee",
    ...
    var classComponentUpdater = {
        ...
        enqueueForceUpdate: function (inst, callback) {
          ...
          null !== injectedProfileingHooks &&
            "function" ===
              typeof injectedProfileingHooks.markForceUpdateScheduled &&
            injectedProfileingHooks.markForceUpdateScheduled(inst, lane);
        }
      },
      reportGlobalError =
    ...
    if (
      !(function () {
        ...
        internals.injectProfileingHooks = injectProfileingHooks;
