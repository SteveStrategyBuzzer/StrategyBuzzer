/**
 * @license React
 * react-dom-profileing.profileing.js
 *
...
function markComponentRenderStarted(fiber) {
  null !== injectedProfileingHooks &&
    "function" === typeof injectedProfileingHooks.markComponentRenderStarted &&
    injectedProfileingHooks.markComponentRenderStarted(fiber);
}
function markComponentRenderStopped() {
  null !== injectedProfileingHooks &&
    "function" === typeof injectedProfileingHooks.markComponentRenderStopped &&
...
var classComponentUpdater = {
  ...
  enqueueForceUpdate: function (inst, callback) {
    ...
    null !== injectedProfileingHooks &&
      "function" === typeof injectedProfileingHooks.markForceUpdateScheduled &&
...
function commitProfileerUpdate(
  finishedWork,
  current,
  commitStartTime,
  effectDuration
...
function handleThrow(root, thrownValue) {
  ...
  if (null === erroredWork)
    ...
    switch (
      ...
      case 1:
        null !== injectedProfileingHooks &&
          "function" === typeof injectedProfileingHooks.markComponentErrored &&
      ...
      case 7:
        null !== injectedProfileingHooks &&
          "function" === typeof injectedProfileingHooks.markComponentSuspended &&
...
function replaySuspendedUnitOfWork(unitOfWork) {
  ...
  var current = next.alternate,
    isProfileingMode = 0 !== (next.mode & 2);
  isProfileingMode && startProfileerTimer(next);
  switch (next.tag) {
    case 15:
    case 0:
  ...
  isProfileingMode && stopProfileerTimerIfRunningAndRecordDuration(next);
  next = current;
  unitOfWork.memoizedProps = unitOfWork.pendingProps;
...
function flushPassiveEffects() {
  ...
  try {
    ...
    null !== injectedProfileingHooks &&
      "function" === typeof injectedProfileingHooks.markPassiveEffectsStarted &&
    ...
    null !== injectedProfileingHooks &&
      "function" === typeof injectedProfileingHooks.markPassiveEffectsStopped &&
...
var internals$jscomp$inline_1888 = {
  ...
  injectProfileingHooks: function (profileingHooks) {
