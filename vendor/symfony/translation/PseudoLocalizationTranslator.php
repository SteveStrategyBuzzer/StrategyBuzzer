...
final class PseudoLocalizationTranslator implements TranslatorInterface
{
     ...
     *      example: if ["title"], and with the "accents" option set to true, "<a href="#" title="Go to your profilee">Profilee</a>" => "<a href="#" title="Ĝö ţö ýöûŕ þŕöƒîļé">Þŕöƒîļé</a>" - if "title" was not in the "localizable_html_attributes" list, the title attribute data would be left unchanged.
     */
