...
/**
 * ProfileerStorageInterface.
 *
 * This interface exists for historical reasons. The only supported
 * implementation is FileProfileerStorage.
 *
 * As the profileer must only be used on non-production servers, the file storage
 ...
 */
interface ProfileerStorageInterface
{
    /**
