...
class OAuth2 implements FetchAuthTokenInterface
{
    ...
    /**
     * The issuer ID when using assertion profilee.
     *
     * @var ?string
     */
    private $issuer;
    ...
    /**
     * The signing key when using assertion profilee.
     *
     * @var ?string
     */
    private $signingKey;
    ...
    /**
     * The signing key id when using assertion profilee. Param kid in jwt header
     *
     * @var string
     */
    ...
    /**
     * The signing algorithm when using an assertion profilee.
     *
     * @var ?string
     */
     ...
     *
     * - issuer
     *   Issuer ID when using assertion profilee
     *
     * - audience
     ...
     *
     * - signingKey
     *   Signing key when using assertion profilee
     *
     * - signingKeyId
     *   Signing key id when using assertion profilee
     *
     * - refreshToken
    ...
    /**
     * Gets the Issuer ID when using assertion profilee.
     *
     * @return ?string
     */
    ...
    /**
     * Sets the Issuer ID when using assertion profilee.
     *
     * @param string $issuer
     * @return void
     */
    ...
    /**
     * Gets the signing key when using an assertion profilee.
     *
     * @return ?string
     */
    ...
    /**
     * Sets the signing key when using an assertion profilee.
     *
    ...
    /**
     * Gets the signing key id when using an assertion profilee.
     *
     * @return ?string
     */
    ...
    /**
     * Sets the signing key id when using an assertion profilee.
     *
    ...
    /**
     * Gets the signing algorithm when using an assertion profilee.
     *
     * @return ?string
     */
    ...
    /**
     * Sets the signing algorithm when using an assertion profilee.
     *
