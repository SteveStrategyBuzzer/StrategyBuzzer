...
class LeagueIndividualFirestoreService
{
    ...
    {
        $normalizedId = DuoFirestoreService::normalizeMatchId($matchId);
        $collectionPath = "games/league-individual-{$normalizedId}/preGeneratedQuestions";
        ...
        if ($result) {
            Log::info("Pre-generated question #{$questionNumber} stored for League Individual match #{$matchId} (correct_index stripped for security)");
        }
