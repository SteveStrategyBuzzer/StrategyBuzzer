    ...
    public static function getAll(): array
    {
        return [
            'illuminate_numbers' => [
                ...
                'short_description' => 'Active automatiquement',
            ...
            'see_opponent_choice' => [
                ...
                'name' => 'Vision',
                'icon' => '👁️',
                'description' => 'Voit le choix de l\'adversaire/IA (1x par partie)',
                'short_description' => 'Active manuellement',
                'avatar' => 'explorateur',
                'type' => self::TYPE_PERSONAL,
                'trigger' => self::TRIGGER_ON_ANSWER,
            ...
            'ai_suggestion' => [
                ...
                'name' => 'IA Assist',
                'icon' => '💡',
                'description' => 'L\'IA suggère une réponse (précision 90%) - 1x par partie',
                'short_description' => 'Active manuellement',
                'avatar' => 'ia_junior',
                'type' => self::TYPE_PERSONAL,
                'trigger' => self::TRIGGER_ON_ANSWER,
            ...
            'eliminate_two' => [
                ...
                'name' => 'Élimination',
                'icon' => '❌',
                'description' => 'Élimine 2 mauvaises réponses sur les 4 (1x par partie)',
                'short_description' => 'Active manuellement',
                'avatar' => 'ia_junior',
                'type' => self::TYPE_PERSONAL,
                'trigger' => self::TRIGGER_ON_ANSWER,
            ...
            'retry_answer' => [
                ...
                'name' => 'Seconde Chance',
                'icon' => '🔄',
                'description' => 'Après une erreur, permet de rechoisir parmi les 3 autres réponses (1x par partie)',
                'short_description' => 'Active après erreur',
                'avatar' => 'ia_junior',
                'type' => self::TYPE_PERSONAL,
            ...
            'shuffle_answers' => [
                ...
                'name' => 'Mélange',
                'icon' => '🔀',
                'description' => 'Les réponses de l\'adversaire changent d\'emplacement toutes les 1.5s',
                'short_description' => 'Active manuellement',
                'avatar' => 'challenger',
                'type' => self::TYPE_ATTACK,
                'trigger' => self::TRIGGER_ON_RESULT,
            ...
            'knowledge_without_time' => [
                ...
                'short_description' => 'Active sans buzz',
                'avatar' => 'historien',
                'type' => self::TYPE_PERSONAL,
                'trigger' => self::TRIGGER_ON_ANSWER,
                'auto' => false,
