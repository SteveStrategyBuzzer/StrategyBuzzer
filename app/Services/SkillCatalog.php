    ...
    public static function getAll(): array
    {
        return [
            ...
            'reduce_time' => [
                ...
                'name' => 'Chrono Réduit',
                'icon' => '⏱️',
                'description' => 'Réduit le chrono de l\'adversaire de 2 sec pendant 5 questions (Manche 1-2), 3 questions (Manche 3), ou 1 question (Manche Ultime)',
                'avatar' => 'challenger',
                'type' => self::TYPE_ATTACK,
                'trigger' => self::TRIGGER_ON_RESULT,
                'auto' => false,
